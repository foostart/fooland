...
function insertPattern() {
    ...
    var patternName = $("#pattenName").val();
    var patternRegex = $("#pattenRegex").val();
    var patternRange = $("#pattenRange").val();
    $.post("/patterns/addnew", { patternName: patternName, patternRegex: patternRegex, patternRange: patternRange, siteId: siteId }, function (data) {
        console.log(data);
    })
}
